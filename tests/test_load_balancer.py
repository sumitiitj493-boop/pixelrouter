...
def test_register_processor_preserves_status_across_bootstrap():
    redis_client = FakeRedis()
    ...
    mark_processor_unreachable(redis_client, "processor-1")
